...
[the essay](../essay/software-factories-are-distributed-systems.md).
...
(`STYLE.md`). The operational form during a recovery pass: every claim about
...
the failure ([the essay](../essay/software-factories-are-distributed-systems.md),
...
[the essay](../essay/software-factories-are-distributed-systems.md): stable
