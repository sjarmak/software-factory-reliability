...
```
python3 -m adapters.in_memory.run_drill effect-commits-ack-is-lost --mode protected
python3 -m adapters.in_memory.run_drill effect-commits-ack-is-lost --mode unsafe
```
