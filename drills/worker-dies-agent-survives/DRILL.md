...
```
python3 src/adapters/in_memory/run_drill.py worker-dies-agent-survives --mode protected
python3 src/adapters/in_memory/run_drill.py worker-dies-agent-survives --mode unsafe
```
