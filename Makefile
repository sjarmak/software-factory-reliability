...
# The seven executable drills, run in protected mode. Names must match the
# DRILLS registry in adapters/in_memory/run_drill.py.
DRILLS ?= worker-dies-agent-survives stale-writer-completes effect-commits-ack-is-lost event-is-lost child-completes-after-join request-accepted-effect-never-applied source-advances-view-answers-anyway
